...
const defaultTemplates = ["simple", "mysql"];
const defaultStateManagers = ["json", "none", "mysql"];
...
exports = module.exports = class Migrate extends EventEmitter {
    ...
    up() {
        return this.pending().then((list) => {
            ...
            return list.up(this.context, this.stateManager);
        });
    }
    ...
    down() {
        return this.executed().then((list) => {
            ...
            return list.down(this.context, this.stateManager);
        });
    }
